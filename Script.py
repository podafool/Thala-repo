...
💠 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/TeamHyperNetworks">S-ᐻ-D</a></b>
"""

    GSTART_TXT = """<b>ʜᴇʏ {},\n\n𝙑𝙖𝙣𝙖𝙠𝙖𝙢..! ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ.\n\n𝗖𝗼𝗻𝘁𝗿𝗼𝗹𝗹𝗲𝗱 𝗕𝘆 : <a href="https://t.me/Soupboy_single">S-ᐻ-ᗫ</a></b>"""
...
☸ ʜᴏꜱᴛᴇᴅ ᴏɴ : <a href="https://t.me/codeflix_bots">🇺‌🇳‌🇰‌🇳‌🇴‌🇼‌🇳‌ 🇸‌🇪‌🇷‌🇻‌🇪‌🇷‌</a>
☸ ʙᴜɪʟᴅ ꜱᴛᴀᴛᴜꜱ : ᴠ4.3.1 [ᴀᴅᴠᴀɴᴄᴇ ғᴇᴀᴛᴜʀᴇs]

⊛  𝘐 𝘤𝘢𝘯 𝘳𝘦𝘴𝘵𝘳𝘪𝘤𝘵 𝘶𝘴𝘦𝘳𝘴‌
⊛  𝘐 𝘩𝘢𝘷𝘦 𝘢𝘯 𝘢𝘥𝘷𝘢𝘯𝘤𝘦𝘥 𝘈𝘶𝘵𝘰-𝘍𝘪𝘭𝘵𝘦𝘳 𝘴𝘺𝘴𝘵𝘦𝘮
⊛  𝘐 𝘤𝘢𝘯 𝘨𝘳𝘦𝘦𝘵 𝘶𝘴𝘦𝘳𝘴 𝘸𝘪𝘵𝘩 𝘤𝘶𝘴𝘵𝘰𝘮𝘪𝘻𝘢𝘣𝘭𝘦 𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘮𝘦𝘴𝘴𝘢𝘨𝘦𝘴.
⊛  𝘏𝘢𝘷𝘦 𝘢𝘯 𝘔𝘢𝘯𝘢𝘨𝘦𝘮𝘦𝘯𝘵 𝘧𝘦𝘢𝘵𝘶𝘳𝘦
⊛  𝘐 𝘩𝘢𝘷𝘦 𝘮𝘢𝘯𝘺 𝘮𝘰𝘥𝘶𝘭𝘦𝘴 𝘭𝘪𝘬𝘦 𝘍𝘪𝘭𝘦 𝘴𝘵𝘰𝘳𝘦, 𝘍𝘰𝘯𝘵, 𝘒𝘢𝘯𝘨 𝘢𝘯𝘥 𝘔𝘰𝘳𝘦.
...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/TeamHyperNetworks">SVD</a></b>"""
...
<b>ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://t.me/Soupboy_single'>ᴏᴡɴᴇʀ</a>
ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://t.me/King_0f_izzy'>ᴍᴀɴᴀɢᴇʀ</a>
ᴄʟɪᴄᴋ ʜᴇʀᴇ - <a href='https://t.me/Idhayann'>ᴜᴘʟᴏᴀᴅᴇʀ</a></b>"""

    SUBSCRIPTION_TXT = """
<b>ʀᴇғᴇʀʀᴇ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ {}

ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=SVD-Mania-{}
...
ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ :
<code>[Button Text](buttonurl:https://t.me/TeamHyperNetworks)</code>
...
💠 𝐆𝐥𝐨𝐛𝐚𝐥 𝐩𝐥𝐚𝐲𝐞𝐫𝐬: <code>{}</code>
💠 𝐆𝐥𝐨𝐛𝐚𝐥 𝐁𝐚𝐬𝐞: <code>{}</code>
💠 𝐔𝐬𝐞𝐝 𝐀𝐦𝐦𝐨: <code>{}</code>
💠 𝐔𝐧-𝐮𝐬𝐞𝐝 𝐀𝐦𝐦𝐨: <code>{}</code></b>"""
...
➮ 𝐏𝐥𝐚𝐲𝐞𝐫 𝐈𝐧𝐟𝐨: <code>{}</code>
➮ 𝐏𝐫𝐨𝐟𝐢𝐥𝐞-𝐈𝐝: {}"""

    ALRT_TXT = """{},
ᴄʜᴇᴄᴋ  ʏᴏᴜʀ  ᴏᴡɴ  ʀᴇǫᴜᴇ𝗌ᴛ 😤 Solider
"""
...
ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇ𝗌ᴛ ᴀɢᴀɪɴ 😊 Solider
"""
...
<b>• {file_name}
❧ ➙➙➙ ◘╭──────────────────╮◘ ➙➙➙
• <a href="https://t.me/TeamHyperNetworks">𝐓ᴇᴀᴍ 𝐇ʏᴘᴇʀs</a>
• <a href="https://t.me/SVDmaniaHypers">Movies Mania</a>
• <a href="https://t.me/TeamHyperBOts">HYPER BOTS</a>
❧ ➙➙➙ ◘⤙─────────────────╯◘ ➙➙➙

• 🇴‌🇵‌🇪‌🇷‌🇦‌🇹‌🇪‌🇩‌ 🇫‌🇷‌🇴‌🇲‌ : <a href="https://t.me/TeamHyperNetworks">𝐓ᴇᴀᴍ 𝐇ʏᴘᴇʀs</a></b>"""
    
    IMDB_TEMPLATE_TXT = """
<b>Query: {query}
𝘐𝘔𝘋𝘉 𝘗𝘳𝘰𝘧𝘪𝘭𝘦 𝘐𝘯𝘧𝘰:

💠 𝐇𝐄𝐀𝐃𝐋𝐈𝐍𝐄‌ : <a href={url}>{title}</a>
💠 𝐂𝐀𝐓𝐄𝐆𝐎𝐑𝐘‌ : {genres}
💠 𝐘𝐄𝐀𝐑‌    : <a href={url}/releaseinfo>{year}</a>
💠 𝐑𝐀𝐓𝐈𝐍𝐆 : <a href={url}/ratings>{rating}</a> / 10 (Based on {votes} user ratings)
💠 𝐂𝐎𝐌𝐌𝐈𝐍𝐈𝐂𝐀𝐓𝐈𝐎𝐍‌ : <code>{languages}</code></a>
💠 𝐓𝐈𝐌𝐄-𝐓𝐀𝐊𝐄𝐍‌ : {runtime} Minutes</a>

💠 🇸‌🇹‌🇴‌🇷‌🇾‌-🇱‌🇮‌🇳‌🇪‌ : <b>{plot}</b> 

<b>💠 𝗖𝗼𝗻𝘁𝗿𝗼𝗹𝗹𝗲𝗱 𝗕𝘆 : {message.from_user.mention}</b>"""
...
⤙⟳ ǤΔΜ€Ř - 𝕮𝖆𝖑𝖑 𝕺𝖋 𝕯𝖚𝖙𝖞 𝕸𝖔𝖇𝖎𝖑𝖊 
⤙⟳ ❝𝐋𝐞𝐯𝐞𝐥❞ - ∞
⤙⟳ ⌊⌋𝙲𝚘𝚗𝚗𝚎𝚌𝚝⌊⌋ - <a href='https://t.me/SVD_Squad_Gamerz'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
⤙⟳ gяσυρ - 𝕿𝖆𝖒𝖎𝖑, 𝕰𝖓𝖌𝖑𝖎𝖘𝖍
⤙⟳ ᴋɴᴏᴡɴ ʟᴀɴɢᴜᴀɢᴇꜱ - 𝕿𝖆𝖒𝖎𝖑, 𝕰𝖓𝖌𝖑𝖎𝖘𝖍 </b>"""
...
ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ɪɴ ˹SVD-Mania˼ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ɢɪᴠᴇ ғᴇᴇᴅʙᴀᴄᴋ ᴀʙᴏᴜᴛ ᴛʜᴇ ʙᴏᴛ˼, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴀᴛ <a href='https://t.me/SVDmania_support'>sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ</a>.</b>"""
...
ᴇxᴀᴍᴘʟᴇ ;- <code>/repo/allrepo Team-Hyper</code>"""
...
ɴᴏᴛᴇ:
• SVD-Mania sʜᴏᴜʟᴅ ʜᴀᴠᴇ ᴀᴅᴍɪɴ ᴘʀɪᴠɪʟʟᴀɢᴇ.
...
💵 Grp name - <code>dm - @TeamHyperNetworks</code>>
📸 Channel name - <a href='https://t.me/Puthusa_yosi'>𝘾𝙡𝙞𝙘𝙠 𝙃𝙚𝙧𝙚 𝙏𝙤 𝙐𝙣𝙡𝙤𝙘𝙠</a>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/Soupboy_single'>ᴏᴡɴᴇʀ</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/Soupboy_single'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
